...
class vacationFrame(customtkinter.CTkFrame):
  def __init__(self, master, main_color, frame_color, previousFrame, orderFrame, cars):
    ...
    self.canvas = customtkinter.CTkCanvas(self, bg = frame_color, width = 1450, height = 815, highlightthickness = 0, scrollregion = (0, 0, 0, 1450))
    ...
    self.folder_path = os.path.join(self.main_dir, '../images/vacation')
  ...
  def createFrames(self):
    ...
    for i, car in enumerate(self.cars):
      ...
      car_seats = customtkinter.CTkLabel(car_frame, text=f'{car['seats']} seats', font=('Helvetica', 16, 'bold'), text_color=self.acc_color)
